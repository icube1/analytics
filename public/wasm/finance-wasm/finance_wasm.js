/* @ts-self-types="./finance_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function evaluate_finance_core(request_json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(request_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.evaluate_finance_core(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {number}
 */
export function finance_core_schema_version() {
    const ret = wasm.finance_core_schema_version();
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('finance_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
