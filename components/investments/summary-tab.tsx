...
const SummaryAllocationCharts = lazy(() =>
  import("./summary-allocation-charts").then((module) => ({
    default: module.SummaryAllocationCharts,
  })),
);
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Suspense fallback={<ChartLoadingFallback />}>
        <SummaryAllocationCharts pieData={pieData} returnData={returnData} />
      </Suspense>
