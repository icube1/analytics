...
const chartLines = [
  ...
  },
  {
    ...
    text: "Покупательная способность портфеля в ценах сегодня. Номинальный баланс делится на накопленную инфляцию с начала расчёта.",
  },
  {
        ...
        <div className="mt-5 space-y-4 rounded-xl bg-zinc-50 p-4 text-sm text-zinc-600 dark:bg-zinc-950 dark:text-zinc-400">
          <div>
            ...
            <ul className="mt-1 list-inside list-disc space-y-1 leading-relaxed">
              <li>Пополнения вносятся в <strong>начале</strong> месяца</li>
              <li>
          ...
          <div>
            ...
            <p className="mt-1 leading-relaxed">
              Сумма задаётся в <strong>ценах сегодня</strong>. В будущем
              списывается больший номинал с учётом накопленной инфляции.
            </p>
          </div>
        </div>
